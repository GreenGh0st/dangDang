  ...
  <body>
	...
	<div id="content">
		<div class="left_menu">
	        ...
	        <li class="nav_dot_li">
	          <h4 class="M3"><a href='javascript:void(0)'><span></span>商品管理</a></h4>
	          <div class="list-item none">
	            <a href="<%=path %>/admin/foods/foods_Manage.jsp" target="contextFrame">管理商品</a>
	        ...
	        <li class="nav_dot_li">
	          <h4 class="M4"><a href='javascript:void(0)'><span></span>会员信息管理</a></h4>
	          <div class="list-item none">
	            <a href="<%=path %>/admin/user/user_Manage.jsp" target="contextFrame">管理会员信息</a>
	            <a href="<%=path %>/admin/user/user_Add.jsp" target="contextFrame">添加新的会员</a>
	          </div>
	        </li>
	        <!-- <li class="nav_dot_li">
