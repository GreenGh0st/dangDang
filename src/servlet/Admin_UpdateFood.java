...
public class Admin_UpdateFood extends HttpServlet {

	/**
		 * Constructor of the object.
		 */
	public Admin_UpdateFood() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int sy =(int)request.getSession().getAttribute("foodID");
		String name = request.getParameter("foodName");
		String jj = request.getParameter("jj");
		String type = request.getParameter("type");
		int price =Integer.parseUnsignedInt(request.getParameter("price"));
