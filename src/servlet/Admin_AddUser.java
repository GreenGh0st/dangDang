...
public class Admin_AddUser extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.print(address);
		  ...
		  int res =ac.addUser(user); 
		  if(res>0){ 
			  out.print("<script>alert('添加成功！');window.location.href='../admin/user/user_Manage.jsp';</script>"); 
			  
			  }else{ out.print("<script>alert('添加失败！');window.history.back();</script>");
		  }
