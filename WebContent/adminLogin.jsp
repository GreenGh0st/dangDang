...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        <td height="300" align="right" valign="middle" class="dl">
            <form id="form1" name="form1" method="post" action="AdminLog">
                <p>
                    <label for="textfield2"></label>
                </p>
                <table width="1190" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td width="600" height="200" align="center" valign="middle">
                            <table width="300" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td height="40" colspan="2" align="center" valign="middle" bgcolor="#FFFFFF">后台登陆</td>
                                </tr>
                                <tr>
                                    <td width="100" height="40" align="center" valign="middle" bgcolor="#FFFFFF">用户名
                                    </td>
                                    <td height="40" align="center" valign="middle" bgcolor="#FFFFFF"><label
                                            for="textfield2"></label>
                                        <input name="txt" type="text" class="dlwb" id="textfield2"/>
